-- RiderPro Complete Database Migration for PostgreSQL/Supabase
-- This script creates all necessary tables for the RiderPro application
...
INSERT INTO schema_migrations (id, version, description, execution_time_ms, checksum) 
VALUES ('complete_migration_001', 1, 'Complete RiderPro database schema with all tables and indexes', 0, 'complete_migration_hash');

-- Success message
DO $$
BEGIN
    RAISE NOTICE 'RiderPro database migration completed successfully!';
